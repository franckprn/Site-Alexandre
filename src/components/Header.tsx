...
const Header = () => {
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-50 bg-white shadow-card"
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <a href="tel:+33603442495" className="hidden sm:block">
              <Button variant="default" size="lg" className="bg-gradient-accent font-semibold">
          ...
          <div className="lg:hidden py-4 animate-fade-in">
            <nav className="flex flex-col space-y-4">
              ...
              <a href="tel:+33603442495" className="sm:hidden">
                <Button variant="default" size="lg" className="w-full bg-gradient-accent font-semibold">
                  <Phone className="mr-2 h-5 w-5" />
                  06 03 44 24 95
                </Button>
              </a>
